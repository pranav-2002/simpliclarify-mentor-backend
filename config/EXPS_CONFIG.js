...
const EXPS_CONFIG = {
  ...
  DISABLE_CREDENTIAL_CRYPTOGRAPHY:
    DISABLE_CREDENTIAL_CRYPTOGRAPHY.toLowerCase().trim() === "true",
  DISABLE_PAYLOAD_CRYPTOGRAPHY:
    DISABLE_PAYLOAD_CRYPTOGRAPHY.toLowerCase().trim() === "true",
  ...
  HTTP_CLIENT_BODY_LOG_ENABLED:
    HTTP_CLIENT_BODY_LOG_ENABLED.toLowerCase().trim() === "true",
  TIMEZONE,
};
